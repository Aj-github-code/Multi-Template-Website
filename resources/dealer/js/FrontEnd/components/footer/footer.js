                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 align-footer">
                         ...
                         <div className="col-md-2 align-footer">
                            ...
                            <ul className="footer-links">
                                {
                                    (typeof this.state.vehicles !== 'undefined') && (this.state.vehicles.length > 0 ) &&
                                    this.state.vehicles.map((value, index)=>{
                                        return(
                                            ...
                                            value.types.map((val, ind)=>{
                                                return(
                                                    <li>
                                                        <Nav.Link key={`vehicle-${index}-${ind}-${val.vehicle_type}`} href={`/vehicle/${value.vehicle_status}/${val.vehicle_type}`}>{textModifier(`${value.vehicle_status} ${val.vehicle_type}`)}</Nav.Link>
                                                    </li>
                                                )
                                            })
                                        )
